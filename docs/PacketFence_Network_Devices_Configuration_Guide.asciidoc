...
The switch Role you will enter, will be the on you created as a group policy in the Meraki configration. To do so go through `Network-wide->Group policies`, here you can create policies that will be applied to the devices which register through this AP.
