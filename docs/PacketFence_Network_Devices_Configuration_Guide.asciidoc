...
It's possible to mix web authentication and downloadable ACLs, for example if you want to be able to redirect the device to the captive portal when a violation is triggered.
